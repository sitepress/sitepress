...
describe Sitepress::SiteController, type: :controller do
  ...
  context "paths" do
    ...
    context "helper_paths" do
      ...
      it { is_expected.to include(Sitepress.configuration.helpers_path.to_s) }
      it "has site#helper_paths in ActiveSupport::Dependencies.autoload_paths" do
        expect(ActiveSupport::Dependencies.autoload_paths).to include(Sitepress.configuration.helpers_path.to_s)
      end
    end
  end
