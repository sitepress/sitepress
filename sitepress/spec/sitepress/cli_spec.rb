...
RSpec.describe Sitepress::CLI do
  describe "constants" do
    ...
    it "has site config path" do
      expect(described_class::SITE_CONFIG_PATH).to eq("config/site.rb")
    end
  end
  ...
  describe "command descriptions" do
    it "server has description" do
      expect(described_class.commands["server"].description).to eq("Run development server")
    end
